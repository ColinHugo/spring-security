...
public class CategoryController {
    ...
    @PostMapping
    public ResponseEntity< Category > createOne( @Valid @RequestBody SaveCategory saveCategory ) {
    ...
    public ResponseEntity< Category > updateOneById( @PathVariable Long categoryId, @Valid @RequestBody SaveCategory saveCategory ) {
